        ...
        <TabsContent value="smart">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">
                Review AI-generated mapping suggestions that take into account field names, data formats, and historical mapping patterns.
              </p>
              <div className="mt-4">
                <p className="text-center text-muted-foreground">Select the "Auto-Map" tab to run the analysis</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
