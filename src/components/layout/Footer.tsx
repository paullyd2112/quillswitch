        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/app/setup" className="text-slate-400 hover:text-primary transition-colors">Start Migration</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/knowledge-base" className="text-slate-400 hover:text-primary transition-colors">Knowledge Base</Link></li>
