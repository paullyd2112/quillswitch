...
import { Calculator, ArrowRight, Users, Briefcase, ShieldCheck, RotateCcw, Code, FileText, Info } from "lucide-react";
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>The total number of users or employees that will be using the system after migration is complete.</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-1.5">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>The average number of contacts or records each user manages in your current system.</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <span className="px-2 py-0.5 bg-primary/10 text-primary text-sm rounded-md font-medium">
