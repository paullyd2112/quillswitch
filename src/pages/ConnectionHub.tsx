          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="manage">
              <div className="grid gap-6">
                ...
                <p className="text-muted-foreground">View and manage all your connected services.</p>
                  ...
                  <Card>
                    ...
                    <CardContent className="p-6 space-y-4">
                      <div className="space-y-3">
                        <div>
                          <h3 className="font-medium mb-1">Where are my API keys stored?</h3>
                          <p className="text-sm text-muted-foreground">
                            Your encrypted API keys are stored securely using advanced encryption.
                          </p>
                        </div>
                        <div>
                          <h3 className="font-medium mb-1">Can QuillSwitch access my API keys?</h3>
                          <p className="text-sm text-muted-foreground">
                            No. Your API keys are encrypted with your personal encryption key that only exists on your device.
                          </p>
                        </div>
                        <div>
                          <h3 className="font-medium mb-1">What happens if I use a different device?</h3>
                          <p className="text-sm text-muted-foreground">
