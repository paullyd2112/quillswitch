  ...
  return (
    <Alert className="mb-6 bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800">
      ...
      <AlertDescription className="text-blue-700 dark:text-blue-300">
        We use Unified.to's secure API platform with OAuth 2.0 authentication. Your credentials are encrypted and managed through enterprise-grade infrastructure.
      </AlertDescription>
    </Alert>
  );
};
