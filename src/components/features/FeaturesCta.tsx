...
const FeaturesCta = () => {
  return (
    <section className="py-16 px-4 md:px-6 bg-slate-900/80">
      <div className="container max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button asChild variant="outline" size="lg" className="border-slate-700 text-slate-300 hover:bg-slate-800/50">
